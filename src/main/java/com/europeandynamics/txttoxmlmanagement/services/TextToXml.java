...
public class TextToXml {
    ...
    public void TextToXmlConverter(String filename) {
        ...
        try {
            ...
            Logger.getLogger(TextToXml.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    private void addParagraphToChapter(XMLStreamWriter writer, String paragraphText, int paragraphCount) throws Exception {
